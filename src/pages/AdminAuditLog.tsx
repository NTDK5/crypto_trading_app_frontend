...
const ACTION_TYPES = [
    'ADMIN_LOGIN',
    'FREEZE_USER_TRADING', 'UNFREEZE_USER_TRADING', 'FREEZE_USER_WITHDRAWALS', 'UNFREEZE_USER_WITHDRAWALS',
    'SUSPEND_USER', 'ACTIVATE_USER', 'RESET_FUND_PASSWORD', 'BALANCE_ADJUSTMENT', 'ADD_USER_NOTE',
    'APPROVE_DEPOSIT', 'REJECT_DEPOSIT', 'APPROVE_WITHDRAWAL', 'REJECT_WITHDRAWAL',
    'PAUSE_PLATFORM_TRADING', 'RESUME_PLATFORM_TRADING',
    'PAUSE_PLATFORM_WITHDRAWALS', 'RESUME_PLATFORM_WITHDRAWALS',
    'ENABLE_MAINTENANCE_MODE', 'DISABLE_MAINTENANCE_MODE',
    'UPDATE_CONFIG', 'SET_EXPOSURE_LIMIT', 'CANCEL_ORDER',
    'SPOT_TRADE', 'LIMIT_ORDER_PLACED', 'LIMIT_ORDER_CANCELLED',
    'STOP_ORDER_PLACED', 'STOP_ORDER_CANCELLED', 'STOP_LIMIT_ORDER_PLACED', 'STOP_LIMIT_ORDER_CANCELLED'
]

const actionSeverity = (type: string): 'danger' | 'warning' | 'info' => {
    if ([
        'FREEZE_USER_TRADING', 'FREEZE_USER_WITHDRAWALS', 'SUSPEND_USER',
        'PAUSE_PLATFORM_TRADING', 'PAUSE_PLATFORM_WITHDRAWALS', 'ENABLE_MAINTENANCE_MODE',
        'REJECT_DEPOSIT', 'REJECT_WITHDRAWAL', 'STOP_LIMIT_ORDER_CANCELLED', 'LIMIT_ORDER_CANCELLED',
    ].includes(type)) return 'danger'
    if ([
        'APPROVE_DEPOSIT', 'APPROVE_WITHDRAWAL', 'BALANCE_ADJUSTMENT',
        'CANCEL_ORDER', 'SET_EXPOSURE_LIMIT', 'SPOT_TRADE', 'UPDATE_CONFIG',
